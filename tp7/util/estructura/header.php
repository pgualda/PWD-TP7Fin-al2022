...
<body>
	...
	<header>
		...
		echo '<a href="../home/index.php"><img  id="LogoInicio" src="../../util/img/logoFerr.svg" alt="logo ferreteria"></a>';
		echo '<div class="centrar-items">';
				...
				foreach ($arreglomenuok as $OBJunmenuhijo) {
					...
					if ($OBJunmenuhijo->getobjmenu() != NULL) {
						if ($OBJunmenuhijo->getobjmenu()->getidmenu() == $OBJunmenu->getidmenu()) {
							...
							echo "	<div>";
							echo "<a href='" . $url . "' class='easyui-menubutton c2'
