...
<table id="dgrol" class="easyui-datagrid" style="width:700px;height:300px" url="listar_rol.php" toolbar="#toolbarrol" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" data-options="method:'post',queryParams:{idmenu:''},title:'Roles'">
...
<script type="text/javascript">
    ...
    function destroyMenu() {
        ...
        if (row) {
            $.messager.confirm('Confirm', 'Seguro que desea eliminar?', function(r) {
                if (r) {
                    $.post('eliminar_menu.php?idmenu=' + row.idpmenu, {
                            idmenu: row.idmenu
                        },
                        function(result) {
    ...
    function borrarmenurol() {
        ...
        if (row) {
            $.messager.confirm('Confirm', 'Seguro que desea eliminar?', function(r) {
                if (r) {
                    $.post('eliminar_menurol.php?idmenu=' + rowmenu.idmenu + '&idrol' + row.idrol, {
