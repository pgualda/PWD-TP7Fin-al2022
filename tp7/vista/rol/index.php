...
<table id="dg" title="Administrador de rols" class="easyui-datagrid" style="width:700px;height:250px"
    url="listar_rol.php" toolbar="#toolbar" pagination="true"rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
            ...
            function destroyRol(){
                ...
                if (row){
                    $.messager.confirm('Confirm','Seguro que desea eliminar?', function(r){
                        if (r){
                            $.post('eliminar_rol.php?idrol='+row.idprol,{idrol:row.idrol},
                               function(result){
