...
<div class="easyui-panel" title="Login" style="width:300px;padding:10px;">
    ...
    <form id="login" method="post" name="login" action="verlogin.php"> <!-- enctype="multipart/form-data"> -->
        <table>
            <tr>
                <td>Usuario:</td>
...
//alert(document.getElementById("uspass").value);
        document.getElementById("okoculto").click();
    }
    ...
    /*        function formSubmit() {
        ...
        if (event.key !== "Enter") return; // Use .key instead.
            document.getElementById("okoculto").click(); // Things you want to do. 
